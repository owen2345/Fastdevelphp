 ...
 * @copyright 2009
 */ 
class Project_dev extends FD_ManageModel
{	
    var $fd_rules = array();
    var $fd_primary_key = 'id_projectdev';
	
	var $id_projectdev; 
	var $versionurl_projectdev; 
	var $serverdev_projectdev; 
	var $serverprod_projectdev; 
	var $credentials_projectdev; 
