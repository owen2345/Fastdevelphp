<script>
    jQuery(function($)
    {
        ...
        {
            var select = $(this);
            /*$.get(ROOT_PATH+"ui_scaffold/getColumns/"+select.val(), function(res)
            {
                $("#list_datas").html(res);
            });*/
            
            $.get(ROOT_PATH+"ui_scaffold/getColumnsData/"+select.val()+"/1", function(res)
            {
...
<form id="form_scaffold" method="post" action="<?php echo ROOT_PATH ?>ui_scaffold/generate">    
    <ul class="main_list">
        <li class="col">
            <label>Model: </label>
        ...
        <li>
            <label><strong>Params</strong>: </label>
            <table id="params">
                <thead>
                    <tr>
                        <th>&nbsp;</th>
