...
<tr id="<?php echo $key ?>">
    ...
    <script>
        ...
        jQuery(function($)
        {
            ...
            {
                var select = $(this);
                $.get(ROOT_PATH+"ui_scaffold/getColumns_and_functions/"+select.val(), { name: "data[<?php echo $key?>][attr_show]" }, function(res)
                {
            ...
            {
                var select = $(this);
                $.get(ROOT_PATH+"ui_scaffold/getColumns_and_functions/"+select.val(), { name: "data[<?php echo $key?>][radio_attr_show]" }, function(res)
                {
            ...
            {
                var select = $(this);
                $.get(ROOT_PATH+"ui_scaffold/getColumns_and_functions/"+select.val(), { name: "data[<?php echo $key?>][checkbox_attr_show]" }, function(res)
                {
